    ...
    return (
        <div className="w-full h-screen flex  bg-[url('/bg.jpg')] bg-cover bg-center  justify-center items-center">
            <div className="w-[400px] h-[650px] backdrop-blur-md rounded-lg shadow-2xl flex flex-col items-center ">
                ...
                <button onClick={handleLogin} className="w-[90%] h-[40px] bg-accent/50 text-white font-bold rounded-lg mt-5 hover:bg-secondary transition-all duration-300">Log in</button>
                ...
                <button onClick={handleLogin} className="w-[90%] h-[40px] bg-primary text-black font-bold rounded-lg mt-5  transition-all duration-300 flex items-center justify-center gap-2 hover:bg-gray-500 "><FcGoogle />Login with Google</button>
